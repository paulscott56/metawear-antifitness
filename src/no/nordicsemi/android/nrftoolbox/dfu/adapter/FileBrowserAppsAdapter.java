...
/**
 * This adapter displays some file browser applications that can be used to
 * select HEX file. It is used when there is no such app already installed on
 * the device. The hardcoded apps and Google Play URLs are specified in
 * res/values/strings_dfu.xml.
 */
public class FileBrowserAppsAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			view = mInflater.inflate(R.layout.app_file_browser_item, parent,
					false);
		}
