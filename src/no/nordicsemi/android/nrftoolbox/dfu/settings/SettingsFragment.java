...
public class SettingsFragment extends PreferenceFragment implements
	...
	public void onResume() {
		...
		// attach the preference change listener. It will update the summary
		// below interval preference
	...
	private void updateNumberOfPacketsSummary() {
		...
		final String value = preferences.getString(SETTINGS_NUMBER_OF_PACKETS,
				String.valueOf(SETTINGS_NUMBER_OF_PACKETS_DEFAULT));
